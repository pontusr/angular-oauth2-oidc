...
export class OAuthService extends AuthConfig {
     ...
     */
    public loadDiscoveryDocumentAndTryLogin(options: LoginOptions = null): Promise<void> {
   ...
   */
     ...
     */
    public tryLogin(options: LoginOptions = null): Promise<any> {
     ...
     */
    private tryLoginImplicit(options: LoginOptions = null): Promise<boolean> {
      options = options || {};
